...
public class SherpafyCustomization extends OsmAndAppCustomization {
	...
	public void setup(OsmandApplication app) {
		...
		selectedTourPref = originalSettings.registerBooleanPreference(
				SELECTED_TOUR, null).makeGlobal();
		File toursFolder = new File(
				originalSettings.getExternalStorageDirectory(), "tours");
	...
	public boolean showFirstTimeRunAndTips(boolean firstTime,
			boolean appVersionChanged) {
		return false;
	}
	...
	//	toursButtonText.setText(R.string.tour);
		...
		toursButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				final Intent search = new Intent(activity,
						getTourSelectionActivity());
